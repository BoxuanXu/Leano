...
class Config : public IAocSingleton<Config> {
 public:
  ...
  void set_EngineType(const std::string& EngineType) {
    cfg_.EngineType = EngineType;
  }
  void set_TaskType(const std::string& TaskType) { cfg_.TaskType = TaskType; }
  void set_Task_Shuffle(const int& Task_Shuffle) {
    cfg_.Task_Shuffle = Task_Shuffle;
  }
  ...
  void set_Ceph_path(const std::string& Ceph_path) {
    cfg_.Ceph_path = Ceph_path;
  }
  void set_DBData_Host(const std::string& DBData_Host) {
    cfg_.DBData_Host = DBData_Host;
  }
  void set_DBData_User(const std::string& DBData_User) {
    cfg_.DBData_User = DBData_User;
  }
  void set_DBData_Pwd(const std::string& DBData_Pwd) {
    cfg_.DBData_Pwd = DBData_Pwd;
  }
  void set_DBTask_Host(const std::string& DBTask_Host) {
    cfg_.DBTask_Host = DBTask_Host;
  }
  void set_DBTask_User(const std::string& DBTask_User) {
    cfg_.DBTask_User = DBTask_User;
  }
  void set_DBTask_Pwd(const std::string& DBTask_Pwd) {
    cfg_.DBTask_Pwd = DBTask_Pwd;
  }
